...
class PushAwayAvoidanceFragment : Fragment() {
    ...
    private fun displayMakeAPlanViews() {
        anxietyText.add(
            ChangingResponseLessonThreeDataClass(
                getString(R.string.push_away_card_1_heading_1),
                null,
                null,
                null,
                null,
                null,
                R.drawable.push_away_1,
                getString(R.string.push_away_card_1_desc_3),
            )
        );
        anxietyText.add(
            ChangingResponseLessonThreeDataClass(
                ...
                getString(R.string.push_away_card_2_desc_1),
                getString(R.string.feelings_enotions_triggered_by_these_thoughts),
                getString(R.string.push_away_card_2_desc_2),
                getString(R.string.behavioural_responses),
                null,
                getString(R.string.push_away_card_2_desc_3),
            )
        );
        anxietyText.add(
            ChangingResponseLessonThreeDataClass(
                getString(R.string.push_away_card_3_heading_1),
                null,
                null,
                null,
                null,
                null,
                R.drawable.push_away_3,
                getString(R.string.push_away_card_3_desc_3),
            )
        );
