...
class SummaryOfDASTFragment:Fragment() {
    private lateinit var binding: SummaryofdastFragmentBinding
    ...
    override fun onCreateView(
        ...
        binding = SummaryofdastFragmentBinding.inflate(inflater, container, false)
    ...
    private fun getCardDescription(cardPosition: Int): String {
        return when (cardPosition) {
            0 -> getString(R.string.dast7_text1_weeklysummary)
            1 -> getString(R.string.dast7_text1_weeklysummary)
            2 ->  getString(R.string.dast7_text1_weeklysummary)
            3 ->  getString(R.string.dast7_text1_weeklysummary)
            4 ->  getString(R.string.dast7_text2_weeklysummary)
            5 ->  getString(R.string.dast7_text1_weeklysummary)
            else -> getString(R.string.dast7_text1_weeklysummary)
        }
    }
