...
class SummaryOfDASTFragment:Fragment() {
    ...
    private fun getCardDescription(cardPosition: Int): String {
        return when (cardPosition) {
            0 -> R.string.dast7_text1_weeklysummary.toString()
            1 ->R.string.dast7_text1_weeklysummary.toString()
            2 -> R.string.dast7_text1_weeklysummary.toString()
            3 -> R.string.dast7_text1_weeklysummary.toString()
            4 -> R.string.dast7_text2_weeklysummary.toString()
            5 -> R.string.dast7_text1_weeklysummary.toString()
            else -> R.string.dast7_text1_weeklysummary.toString()
        }
    }
