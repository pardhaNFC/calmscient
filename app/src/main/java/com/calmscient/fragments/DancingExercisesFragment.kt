...
import com.calmscient.databinding.DancingexercisesBinding
import com.calmscient.databinding.HandoverYourHeartExercisesBinding
class DancingExercisesFragment : Fragment() {
    private lateinit var binding: DancingexercisesBinding
    ...
    override fun onCreateView(
        ...
        binding = DancingexercisesBinding.inflate(inflater, container, false)
