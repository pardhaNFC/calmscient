...
class CopyingWithStressFragment : Fragment() {
    private lateinit var binding: FragmentCopyingWithStressBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCopyingWithStressBinding.inflate(inflater, container, false)
