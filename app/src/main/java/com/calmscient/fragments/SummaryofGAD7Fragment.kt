...
class SummaryofGAD7Fragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = Summaryofgad7FragmentBinding.inflate(inflater, container, false)
    ...
    private fun getCardDescription(cardPosition: Int): String {
        return when (cardPosition) {
            0 -> R.string.gad7_text1_weeklysummary.toString()
            1 -> R.string.gad7_text1_weeklysummary.toString()
            2 -> R.string.gad7_text1_weeklysummary.toString()
            3 -> R.string.gad7_text1_weeklysummary.toString()
            4 -> R.string.gad7_text2_weeklysummary.toString()
            5 -> R.string.gad7_text1_weeklysummary.toString()
            else -> R.string.gad7_text1_weeklysummary.toString()
        }
    }
