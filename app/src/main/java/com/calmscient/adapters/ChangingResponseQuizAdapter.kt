...
class ChangingResponseQuizAdapter(private val context: Context, private val questions: List<Question>, val title: String) :
    RecyclerView.Adapter<ChangingResponseQuizAdapter.ChangingResponseQuizHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ChangingResponseQuizHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.questions_item_card_view, parent, false)
        return ChangingResponseQuizHolder(itemView)
    }

    inner class ChangingResponseQuizHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onBindViewHolder(holder: ChangingResponseQuizHolder, position: Int) {
