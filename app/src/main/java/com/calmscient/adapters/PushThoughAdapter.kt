...
class PushThoughAdapter(
    private val context: Context,
    val items: MutableList<ChangingResponseLessonThreeDataClass>
) :
    RecyclerView.Adapter<PushThoughAdapter.PushThoughHolder>() {
    override fun onCreateViewHolder(
        ...
        return PushThoughHolder(itemView)
    }



    override fun onBindViewHolder(holder: PushThoughHolder, position: Int) {
    ...
    inner class PushThoughHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
