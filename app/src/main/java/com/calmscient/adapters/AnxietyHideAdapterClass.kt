...
import com.calmscient.activities.AnxietyHideDataClass

class AnxietyHideAdapterClass(private val items: MutableList<AnxietyHideDataClass>) :
    RecyclerView.Adapter<AnxietyHideAdapterClass.AnxietyHideViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AnxietyHideViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.layout_hide_adapter, parent, false)
        return AnxietyHideViewHolder(itemView)
    }

    override fun getItemCount(): Int = items.size

    @SuppressLint("ResourceAsColor")
    override fun onBindViewHolder(holder: AnxietyHideViewHolder, position: Int) {
    ...
    inner class AnxietyHideViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
